        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm animate-fade-in">
                <CardContent className="p-8 text-center">
                  <div className="w-48 h-48 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full mx-auto mb-6 overflow-hidden border-4 border-white shadow-lg">
                    <div className="w-full h-full bg-gray-300 flex items-center justify-center text-gray-500">
                      <span className="text-lg font-medium">Profile Photo</span>
                    </div>
                  </div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-2">Shubhash Nath Thakur</h2>
                  <p className="text-gray-600 mb-4">Technical Artist & Level Designer</p>
                  <div className="flex flex-wrap gap-2 justify-center">
                    <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-200">Unreal Engine</Badge>
                    <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200">Procedural Art</Badge>
                    <Badge className="bg-green-100 text-green-800 hover:bg-green-200">Optimization</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '0.1s' }}>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-gray-600">unreal.shubhu@gmail.com</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-gray-600">+91 90765 33088</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Bio */}
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              {/* Education */}
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '0.3s' }}>
                <CardContent className="p-8">
                  ...
                  <div className="space-y-6">
                    <div className="border-l-4 border-blue-600 pl-6">
                      <h4 className="text-lg font-semibold text-gray-900">Game Design & Development</h4>
              ...
              {/* Experience */}
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <CardContent className="p-8">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center gap-3">
                  ...
                  <div className="space-y-8">
                    <div className="border-l-4 border-purple-600 pl-6">
                      <h4 className="text-lg font-semibold text-gray-900">Technical Artist | Level Designer</h4>
                    ...
                    <div className="border-l-4 border-green-600 pl-6">
                      <h4 className="text-lg font-semibold text-gray-900">Video Editor</h4>
